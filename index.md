   ...
   * ### Ενισχυτικό 2(07/11/21)
    ...
    * ### Ενισχυτικό 3(13/11/21) 
     ...
     * ### Ενισχυτικό 4(20/11/21)
        Σχετικά με την εργασία:bangbang: Δείτε στο τμήμα **ΕΡΓΑΣΙΕΣ**->Εργασία 1
    ...
    * ### Ενισχυτικό 7(12/11/21)
        ...
        * [readutf8_chars_example](https://github.com/vasnastos/OOP/blob/main/Lesson_7/readutf8.cpp)

        * [lambdas](https://github.com/vasnastos/OOP/blob/main/Lesson_7/lambdas.cpp)

        * [lambdas combine with vector](https://github.com/vasnastos/OOP/blob/main/Lesson_7/lambdas_combine_with_vectors.cpp)


        * Κατασκευη παραθύρου με χρήση του framework των wxwidgets
        ```
            #include <wx/wx.h>
        ...
        * Παράδειγμα με βαθμoλoγίες φοιτητών και χρήση λίστας
        ```
            #include <wx/wx.h>
        ...
        * Παράδειγμα διαγραφής στοιχείου από λίστα.
